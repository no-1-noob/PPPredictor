...
namespace PPPredictor.Shared.Predictor
{
    internal class PPPredictorDummy : IPPPredictor
    {
        ...
        public string LeaderBoardIcon => "PPPredictor.Shared.Resources.LeaderBoardLogos.ScoreSaber.png";
...
#pragma warning restore CS0067
        ...
        public Task UpdateCurrentBeatMapInfos(PPPBeatMapInfo beatMapInfo)
        {
            return Task.CompletedTask;
        }
    }
