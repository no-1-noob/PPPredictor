...
#pragma warning disable CS1998
        public static async Task<string> GetCurrentVersionAsync(string pageUrl)
        {
#if (!DEBUG)
            try
            {
                ...
                HttpResponseMessage response = await client.GetAsync("api/PPPredictorVersion_"+pageUrl);
