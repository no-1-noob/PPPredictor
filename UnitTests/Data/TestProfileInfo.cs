...
namespace UnitTests.Data
{
    ...
    public class TestProfileInfo
    {
        ...
        public void ClearOldMapInfos()
        {
            ...
            int count = profileInfo.LsLeaderboardInfo.Sum(x => x.LsMapPools.Sum(x => x.LsLeaderboadInfo.Count()));
            Assert.IsTrue(count == 2, "Two scores should exist");
            profileInfo.ClearOldMapInfos();
            count = profileInfo.LsLeaderboardInfo.Sum(x => x.LsMapPools.Sum(x => x.LsLeaderboadInfo.Count()));
        ...
        public void ResetCachedData()
        {
            ...
            int countLsLeaderboadInfo = profileInfo.LsLeaderboardInfo.Sum(x => x.LsMapPools.Sum(x => x.LsLeaderboadInfo.Count()));
            int countLsScoresInfo = profileInfo.LsLeaderboardInfo.Sum(x => x.LsMapPools.Sum(x => x.LsScores.Count()));
            ...
            countLsLeaderboadInfo = profileInfo.LsLeaderboardInfo.Sum(x => x.LsMapPools.Sum(x => x.LsLeaderboadInfo.Count()));
            countLsScoresInfo = profileInfo.LsLeaderboardInfo.Sum(x => x.LsMapPools.Sum(x => x.LsScores.Count()));
