...
#pragma warning restore CS0649
        ...
        private async void SetupHandleTexture()
        {
            ...
            Texture2D tex = await BeatSaberMarkupLanguage.Utilities.LoadTextureFromAssemblyAsync("PPPredictor.Shared.Resources.moveIcon.png");
...
#pragma warning restore IDE0051 // Remove unused private members
        ...
        {
            get => _isScreenMoving ? "PPPredictor.Shared.Resources.gIconLockOpen.png" : "PPPredictor.Shared.Resources.gIconLockClosed.png";
        }
        #endregion
        ...
        private async void CheckVersion()
        {
            if (Plugin.ProfileInfo.IsVersionCheckEnabled && (DateTime.Now - Plugin.ProfileInfo.DtLastVersionCheck).TotalHours >= 12)
            {
                ...
                NewVersion = await VersionChecker.VersionChecker.GetCurrentVersionAsync(Plugin.BeatSaberVersion);
