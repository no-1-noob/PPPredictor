...
namespace PPPredictor.Counter
{
    class CounterInfoHolder
    {
        ...
        public CounterInfoHolder(int id, Leaderboard leaderboard, CustomConfigModel settings, PPPredictorMgr ppPredictorMgr, Canvas canvas, CanvasUtility canvasUtility, float lineOffset, float offsetByLine, float positionScale, LeaderBoardGameplayInfo leaderBoardGameplayInfo) //CHECK WHEN NO C+ is installed??
        {
            this.id = id;
